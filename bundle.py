...
def runCmds():
    cmds = [
    "terser -c ecma=2016 -m --manglge-props --source-map -o output/main.min.js helpers/utils.js helpers/enums.js helpers/tour.js helpers/peerjs-options.js classes/* main.js",
